...
async def secure_group(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("Copyright protection 🔒", callback_data=f"copyright|{group_id}"),
            InlineKeyboardButton("LINK Security 🔒", callback_data=f"link|{group_id}")
        ],
        [
            InlineKeyboardButton("Spam 🔒", callback_data=f"spam|{group_id}"),
            InlineKeyboardButton("Words limitations 🔒", callback_data=f"words|{group_id}")
        ]
    ])
